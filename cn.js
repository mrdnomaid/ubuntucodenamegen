...
const months = [4, 4, 4, 10, 10];
const currentYr = parseInt(new Date().getFullYear().toString().substr(2, 2));
...
$.get('animals.txt', function(text) {
  let animals = shuffleArray(text.split('\n'));
  ...
  $.get('adj.txt', function(text) {
    ...
    let adjs = shuffleArray(text.split('\n'));
